...
const BudgetImpact = memo(function BudgetImpact({ currentBudgetM, priceMillions, canAfford, afterColor, budgetAfterM, budgetAfterPercent, barColor, missingM }) {
  return (
    <div
...
export const PlayerModal = memo(function PlayerModal({
  ...
  }, [player.Precio, remainingBudget, userProfile?.budget]);
  ...
  const ActionButton = useCallback(() => {
    ...
    lockedTeamName,
    marketStatus?.status,
    meetsFranchiseCriteria,
    player,
    remainingBudget,
    userProfile?.budget,
    userProfile?.franchisePlayerUsed,
  ]);
